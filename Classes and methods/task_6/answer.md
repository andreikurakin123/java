...
a.printNum(1.11f); Это также примитивный тип float, который будет упакован в Float.
Вывод: Float = 1.1100.

a.printNum(11.11); Это примитивный тип double, который также будет упакован в объект. Но поскольку не найдено ни одного метода, принимающего double, используется метод printNum(Number n).
Вывод: Number=11.11.
